...
var Customer_dto_1 = require("../dio/Customer.dto");
...
var CustomerSignUp = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var customerInput, inputErrors, email, password, phone, vendorExit, genSalt, hashPassword, _a, otp, expiry, createCustomer, signature;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                customerInput = (0, class_transformer_1.plainToClass)(Customer_dto_1.CreateCustomerInput, req.body);
                return [4 /*yield*/, (0, class_validator_1.validate)(customerInput, {
                        validationError: { target: true },
                    })];
            case 1:
                inputErrors = _b.sent();
                if (inputErrors.length > 0) {
                    return [2 /*return*/, res.status(400).json({ message: inputErrors })];
                }
                email = customerInput.email, password = customerInput.password, phone = customerInput.phone;
                return [4 /*yield*/, Customer_1.Customer.find({ email: email })];
            case 2:
                vendorExit = _b.sent();
                if (vendorExit.length > 0) {
                    return [2 /*return*/, res.status(400).json({ message: "Customer already exist" })];
                }
            ...
            case 6:
                createCustomer = _b.sent();
                if (!createCustomer) return [3 /*break*/, 8];
                return [4 /*yield*/, (0, passwordUnility_1.generateToken)({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, (0, passwordUnility_1.ValidatePassword)(password, customer.password, customer.salt)];
            case 3:
                validation = _a.sent();
                if (validation) {
                    signature = (0, passwordUnility_1.generateToken)({
                        _id: customer._id,
