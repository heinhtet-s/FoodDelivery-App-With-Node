...
var onRequestOTP = function (otp, toPhoneNumber) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                accountSid = "AC447df969d59ad8613d2d84835d21cf7f";
                authToken = "f0e72870679592912ca3c559fa0e12e5";
                client = require("twilio")(accountSid, authToken);
                console.log(client);
                return [4 /*yield*/, client.messages.create({
                        body: "Your OTP is ".concat(otp),
                        from: "+43720",
                        to: "".concat(toPhoneNumber), // recipient phone number // Add country before the number
                    })];
            case 1:
                response = _a.sent();
